...
public class LisImplClass implements ITestListener{
	...
	public void onStart(ITestContext context) {
		//TestScript Execution Starts from here
				...
				htmlreport.config().setDocumentTitle("saucedemo.Automation Testing"); // Title of the Report
				htmlreport.config().setReportName("Seniour SDET"); // Name of the report
				...
				report.setSystemInfo("Reporter Name", "Leoooo");	
	}
	@Override
